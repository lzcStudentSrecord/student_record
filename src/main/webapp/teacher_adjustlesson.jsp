...
<body
	...
	<div
		...
		<div>
			<form action="/AdjustLesson/insertByTeacher" method="post">
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>调课原因</strong><input name="reason"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text" >
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>课程名称</strong><input name="course"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>原上课时间</strong><input name="oldtime"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>原上课时间教室</strong><select name="oldaddress" id="oldaddress">

					</select>
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>补课时间</strong><input name="newtime"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>补课教室</strong><select name="newaddress" id="newaddress">

					</select>
				</h3>
				<br> <br> <input class="bootstrap-frm2" type="submit">
				<br>
			</form>
		</div>
	</div>
...
<script type="text/javascript"
	src="resources/form-3/assets/js/bootstrap-table.js"></script>
<script type="text/javascript"
	src="resources/controller/teacher_adjustlesson_controller.js"></script>
</html>
