...
<body
	...
	<div
		...
		<div>
			<form action="/Student/updateByTeacher" method="post">
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>学生学号</strong><input name="sno"
						value="${updatestudent.sno }" 
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text" readonly="readonly">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>学生姓名</strong><input name="sname"
						value="${updatestudent.sname }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<section>
					...
					<div style="margin-top: 20px;" class="pretty circle">
						<input type="radio" name="sgender" value="男"
							<c:if test="${updatestudent.sgender eq '男'}">checked="checked"</c:if>>
						<label><i class="default"></i>男</label>
					</div>
					<div class="pretty circle">
						<input type="radio" name="sgender" value="女"
							<c:if test="${updatestudent.sgender eq '女'}">checked="checked"</c:if>>
				...
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>年级</strong><input name="sgrade"
						value="${updatestudent.sgrade }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>班级</strong><input name="sclass"
						value="${updatestudent.sclass }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>院系</strong><input name="sdept"
						value="${updatestudent.sdept }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>家庭住址</strong><input name="saddress"
						value="${updatestudent.saddress }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>联系方式</strong><input name="sphone"
						value="${updatestudent.sphone }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>父/母姓名</strong><input name="sparent"
						value="${updatestudent.sparent }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>父/母联系方式</strong><input name="sparentPhone"
						value="${updatestudent.sparentPhone }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>就职情况</strong><input name="sjob"
						value="${updatestudent.sjob }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>在校情况</strong><select name="sstate">
						<option
							<c:if test="${updatestudent.sstate eq '在校'}">selected="selected"</c:if>>在校</option>
						<option
							<c:if test="${updatestudent.sstate eq '休学'}">selected="selected"</c:if>>休学</option>
						<option
							<c:if test="${updatestudent.sstate eq '入伍'}">selected="selected"</c:if>>入伍</option>
						<option
