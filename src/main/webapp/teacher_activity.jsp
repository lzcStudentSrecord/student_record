	...
	<div
		...
		<div>
			<form action="/Activity/insertByStudent" method="post">
				...
				<textarea name="acontent" class="bootstrap-frm1" readonly="readonly">value="${activityupdate.readonly }"</textarea>
				<br> <strong>活动作用</strong><br>
				<textarea name="aaffect" class="bootstrap-frm1" readonly="readonly">value="${activityupdate.readonly }"</textarea>
