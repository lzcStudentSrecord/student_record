...
<body
	...
	<div
		...
		<p
			style="text-align: left; color: #000; font-size: 25px; text-overflow: ellipsis;">活动列表</p>
		<c:forEach items="${activitylist }" var="activity">
			<p
				style="text-align: left; color: #000; font-size: 25px; text-overflow: ellipsis;">你申请的活动${activity.aname }已通过审核</p>
			<br>
			<hr>
		</c:forEach>
		<hr>
		<p
			style="text-align: left; color: #000; font-size: 25px; text-overflow: ellipsis;">教室申请列表</p>
		<c:forEach items="${applyroomlist }" var="applyroom">
			<p
				style="text-align: left; color: #000; font-size: 25px; text-overflow: ellipsis;">你申请的教室${applyroom.craddress }已通过审核</p>
			<br>
			<hr>
		</c:forEach>
	</div>
