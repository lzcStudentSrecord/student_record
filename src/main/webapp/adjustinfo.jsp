	...
	<div
		...
		<div>
			<h3 style="text-align: left; margin-left: 25%; color: #000;">
				<strong>调课原因</strong><input value="${adjustinfo.reason }"
					style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
					type="text" readonly="readonly">
			</h3>
			<br>
			<h3 style="text-align: left; margin-left: 25%; color: #000;">
				<strong>课程名称</strong><input value="${adjustinfo.course }"
					style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
					type="text" readonly="readonly">
			</h3>
			<br>
			<h3 style="text-align: left; margin-left: 25%; color: #000;">
				<strong>原上课时间</strong><input value="${adjustinfo.oldtime }"
					style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
					type="text" readonly="readonly">
			</h3>
			<br>
			<h3 style="text-align: left; margin-left: 25%; color: #000;">
				<strong>原上课时间教室</strong><input value="${adjustinfo.oldaddress }"
					style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
					type="text" readonly="readonly">
			</h3>
			<br>
			<h3 style="text-align: left; margin-left: 25%; color: #000;">
				<strong>补课时间</strong><input value="${adjustinfo.newtime }"
					style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
					type="text">
			</h3>
			<br>
			<h3 style="text-align: left; margin-left: 25%; color: #000;">
				<strong>补课教室</strong><input value="${adjustinfo.newaddress }"
					style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
					type="text" readonly="readonly">
			</h3>
			<br>
