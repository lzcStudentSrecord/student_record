...
<body
	...
	<div
		...
		<div>
			<form action="../StudentTextbook/updateByStno" method="post">
				<input type="hidden" name="stno" value="${stubooktemp.stno }">
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>学号</strong><input name="sno" value="${stubooktemp.sno }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text" readonly="readonly">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>教材名称</strong><input name="tbname"
						value="${stubooktemp.tbname }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text" readonly="readonly">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>教材数量</strong><input name="num" value="${stubooktemp.num }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="number" readonly="readonly">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>教材价格</strong><input name="price"
						value="${stubooktemp.price }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text" readonly="readonly">
				</h3>
				<br>
