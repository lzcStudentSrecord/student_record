...
<body
	...
	<div
		...
		<div>
			<form action="/Credit/updateByCredit" method="post">
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>学&nbsp&nbsp号</strong><input name="sno"
						value="${updatecredit.sno }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<br>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>课程名称</strong><input name="cname"
						value="${updatecredit.cname }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>课程类型</strong><select name="ctype">
						<option
							<c:if test="${updatecredit.ctype eq '必修' }"> selected="selected"</c:if>>必修</option>
						<option
							<c:if test="${updatecredit.ctype eq '选修' }"> selected="selected"</c:if>>选修</option>
						<option
							<c:if test="${updatecredit.ctype eq '公选' }"> selected="selected"</c:if>>公选</option>
					</select>
				</h3>
				<h3 style="text-align: left; margin-left: 25%; color: #000;">
					<strong>加分情况</strong><input name="cscore"
						value="${updatecredit.cscore  }"
						style="height: 40px; border: 1px solid #d1d1d1; border-radius: 20px; margin-left: 20px; margin-top: 10px;"
						type="text">
				</h3>
