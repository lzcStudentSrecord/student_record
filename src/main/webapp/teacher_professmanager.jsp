...
<body
	...
	<div>
		...
		<div style="width: 30%; height: 100%; margin: 0 auto">
			<button id="stutb_insert" class="bootstrap-frm2">查看需要确认的证书</button>
		</div>
	</div>
	<div class="wrapper">
			...
			<div class="row">
                ...
                -->
						...
						<table id="fresh-table" class="table">
							...
							<tbody>
								<c:forEach items="${professCertificatelist }"
									var="professCertificate">
									<tr>
										<td>${professCertificate.sno }</td>
										<td>${professCertificate.pctype }</td>
										<td>${professCertificate.pctime }</td>
										<td>${professCertificate.pcoffice }</td>
										<td>
...
$("#stutb_insert").click(function(i){
	location="../ProfessCertificate/selectByTnoWithNoPass";
});
</script>
</html>
